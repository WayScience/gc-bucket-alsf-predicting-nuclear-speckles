...
1. Communicate with Data receiver about data access readiness with their account and the bucket name (for example `gc-bucket-alsf-predicting-nuclear-speckles`).
